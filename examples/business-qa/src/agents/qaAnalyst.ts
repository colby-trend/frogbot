...
import { dataSummarizer, dateHelper, googleCalendar, googleDrive, googleSheets, pdf } from '../pieces';
...
const releaseRisk = {
  ...
  execute: ({ openBlockers, daysToLaunch }: { openBlockers: number; daysToLaunch: number }) => ({
