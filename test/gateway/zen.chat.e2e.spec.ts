      ...
      async () => {
        ...
        const res = await streamChat(
          app,
          {
            model: MODEL,
            messages: [
              { role: 'user', content: 'Write a long story about a frog. At least 500 words.' },
            ],
            max_tokens: 2048,
          },
            ...
            tool_calls: [
              {
                id: callA.id,
                type: 'function',
                function: { name: callA.function!.name, arguments: callA.function!.arguments },
              },
            ],
          },
          {
    ...
    it(
      ...
      async () => {
        const messages: Array<Record<string, unknown>> = [
          {
            role: 'system',
            content: 'You are a terse travel assistant. Always answer in as few words as possible.',
          },
