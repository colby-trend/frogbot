...
import type { AgentConfig, AgentModelId } from '../../../../packages/frogbot/src/types/agent.js';
import type { BedrockProviderEntry, BuiltInProviderEntry, ModelId, ProviderConfig } from '../../../../packages/frogbot/src/types/ai.js';
...
describe('AI config types', () => {
  ...
  it('rejects arbitrary model strings', () => {
    ...
    expectTypeOf<ModelId>().toEqualTypeOf<import('../../../../packages/frogbot/src/types/ai.js').BaseAIOpts['model']>();
  });
});
