...
import { toOpenAITranscriptionResponse } from '../../../../../../packages/gateway/src/routes/transcriptions/translators/toResponse.js';
...
describe('toOpenAITranscriptionResponse', () => {
  ...
  it('keeps verbose_json language and duration present without upstream values', () => {
    ...
    expect(
      toOpenAITranscriptionResponse({ result: sparse, responseFormat: 'verbose_json' }),
    ).toEqual({
      task: 'transcribe',
      text: 'Hello',
      language: '',
