...
import type { EmbeddingsRequest } from '../../../../packages/gateway/src/routes/embeddings/schema.js';
import { toEmbedParams } from '../../../../packages/gateway/src/routes/embeddings/translators/index.js';
import type { ImagesRequest } from '../../../../packages/gateway/src/routes/images/schema.js';
import { toGenerateImageParams } from '../../../../packages/gateway/src/routes/images/translators/index.js';
import type { RerankRequest } from '../../../../packages/gateway/src/routes/rerank/schema.js';
import { toRerankParams } from '../../../../packages/gateway/src/routes/rerank/translators/index.js';
import type { ResponsesRequest } from '../../../../packages/gateway/src/routes/responses/schema.js';
import { toModelMessages } from '../../../../packages/gateway/src/routes/responses/translators/index.js';
import type { SpeechRequest } from '../../../../packages/gateway/src/routes/speech/schema.js';
import { toSpeechParams } from '../../../../packages/gateway/src/routes/speech/translators/index.js';
import type { TranscriptionRequest } from '../../../../packages/gateway/src/routes/transcriptions/schema.js';
import { toTranscribeParams } from '../../../../packages/gateway/src/routes/transcriptions/translators/index.js';
import type { VideosRequest } from '../../../../packages/gateway/src/routes/videos/schema.js';
import { toGenerateVideoParams } from '../../../../packages/gateway/src/routes/videos/translators/index.js';
