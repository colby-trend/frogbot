...
import { createOAuthCredentialSource } from '../../../packages/plugins/plugin-oauth/src/source.js';
import type { OAuthProvider } from '../../../packages/plugins/plugin-oauth/src/types.js';
