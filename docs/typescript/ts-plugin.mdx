...
FrogBot ships an optional TypeScript Language Service Plugin (`@frogbotai/typescript-plugin`) that enhances your IDE experience when working with [Custom Components](/custom-components/overview). It understands FrogBot's `PayloadComponent` import path conventions and provides:
